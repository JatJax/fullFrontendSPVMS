  ...
  <div v-if="pageDisplay=='display'">
    <div>
      ...
      <b-dropdown id="filter-dropdown" text="Choose Filter" class="m-md-2">
        ...
        <b-dropdown-item @click="filterByOne('Approved')">Most Recent (60 Days)</b-dropdown-item>
        <b-dropdown-item @click="filterByOne('Pending Approval')">By Center</b-dropdown-item>
      </b-dropdown>
    </div>
